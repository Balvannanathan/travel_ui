...
mixin _$LoginScreenModel on _LoginScreenModelBase, Store {
  ...
  late final _$isNextButtonEnabledAtom = Atom(
    name: '_LoginScreenModelBase.isNextButtonEnabled',
    context: context,
  );
  ...
  late final _$loginErrorTextAtom = Atom(
    name: '_LoginScreenModelBase.loginErrorText',
    context: context,
  );

  @override
  String get loginErrorText {
    _$loginErrorTextAtom.reportRead();
    return super.loginErrorText;
  }

  @override
  set loginErrorText(String value) {
    _$loginErrorTextAtom.reportWrite(value, super.loginErrorText, () {
      super.loginErrorText = value;
    });
  }
  ...
  void setIsNextButtonEnabled(bool value) {
    final _$actionInfo = _$_LoginScreenModelBaseActionController.startAction(
      name: '_LoginScreenModelBase.setIsNextButtonEnabled',
    );
    try {
  ...
  void setLoginErrorText(String value) {
    final _$actionInfo = _$_LoginScreenModelBaseActionController.startAction(
      name: '_LoginScreenModelBase.setLoginErrorText',
    );
    try {
      return super.setLoginErrorText(value);
    } finally {
      _$_LoginScreenModelBaseActionController.endAction(_$actionInfo);
    }
  }
